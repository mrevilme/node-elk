...
/**
 * sms: Sens a text message to a give phone number.
 *
 ...
 * @param {String} to: Phone number of the recipient.
 */
Phone.prototype.call = function(to) {
  return new Call(this.elk, {from : this.number, to : to, phone : this});
};

/**
 * _message: Private helper to abstract different message types (such as SMS/MMS).
 */
Phone.prototype._message = function(to, text, type, callback) {
  this.client.post("/" + type, { from : this.number, to : to, message : text }, function(error, response) {
