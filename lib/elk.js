...
/**
 * sendMessage: Send a message using 46elks
 *
 * @param {Message} message
 * @param {Map} Options
 * @param {Function} callback 
 */
 Elk.prototype.sendMessage = function(message, options, callback) {
    ...
    arguments = options
    arguments.to = message.to;
    arguments.from = message.from;
    arguments.message = message.message;

    this.client.post("/SMS", arguments, function(error, response) {
