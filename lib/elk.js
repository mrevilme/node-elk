var System = require("sys"),
    ...
    Message = require("./elk/message").Message,
...
var Elk = function(options) {
  ...
  this.listen = options.listen ? options.listen : {};
  ...
  this.express.post(this.listen.path || "elk", function(request, response) {
    if (request.body.message) {
      this.emit("sms", new Message(this, {
        id        : request.body.id,
    ...
    } else if (request.body.callid) {
      this.emit("call", new Call(this, {
...
System.inherits(Elk, EventEmitter);
